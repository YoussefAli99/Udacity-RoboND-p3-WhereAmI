...
// This function publishes the requested linear x and angular velocities to
// the robot wheel joints. After publishing the requested velocities,
...
bool handle_drive_request(
    ...
    // Set wheel velocities (linear + angular)
    ...
    res.msg_feedback = "Linear_x : " + std::to_string(linear_x)
